...
ALLOWED_HOSTS = ['localhost', '127.0.0.1']  # Allow local development access
...
TEMPLATES = [
    {
        ...
        'DIRS': [BASE_DIR / 'templates'],  # Fixed spacing and syntax
        'APP_DIRS': True,
        'OPTIONS': {
            'context_processors': [
...
STATIC_URL = '/static/'
STATICFILES_DIRS = [BASE_DIR / 'static']  # Added for static file support
